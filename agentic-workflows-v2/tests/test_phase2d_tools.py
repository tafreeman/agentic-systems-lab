...
@pytest.mark.asyncio
@pytest.mark.skipif(os.name == "nt", reason="echo is a Windows shell builtin, not subprocess-exec callable")
...
@pytest.mark.asyncio
@pytest.mark.skip(reason="ShellTool uses allowlist, not a 'dangerous' blocklist; test assertion is incompatible with current implementation")
