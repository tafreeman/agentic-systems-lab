...
except ImportError:  # pragma: no cover - depends on optional langgraph version
...
def create_agent(
    ...
    *,
    ...
    if create_react_agent is None:
        raise ImportError(
            "LangGraph ReAct agent factory is unavailable. Install a compatible "
            "langgraph version or use validate_only/tier-0 workflows."
        )
