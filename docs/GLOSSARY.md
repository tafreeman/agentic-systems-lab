...
A reference of key terms, patterns, and abstractions used throughout the `tafreeman/agentic-systems-lab` monorepo. Each entry includes a concise definition and a pointer to the relevant source code or configuration.
